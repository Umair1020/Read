    ...
    <div>
      <main>
        <div className="sc-f7a1231a-0 eAOrTQ">
          <div className="sc-f7a1231a-1 bivDfV"></div> <Header />
        </div>
        <div className="sc-73f9991a-0 bMzgOT">
          <div className="sc-73f9991a-1 dFgVDd">
            <div className="sc-73f9991a-2 jiRoFs">
              ...
              <br />
              <br />
              <h1 className="text-center">Chat with any PDF document</h1>
          ...
          >
            ...
            <div className="group relative bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Say goodbye to boring number crunching! Chat with your
                  financial reports using Magicaldocs and get quick answers like
                  a pro.
                </p>
              </div>
              <span
